    ...
    <main class="flex items-center h-screen">
      <div class="w-full sm:w-3/4 md:w-3/5 lg:w-2/5 max-w-xs mx-auto px-6 md:px-0 relative">
        ...
        <section class="bg-gray-100 mx-auto px-8 py-6 rounded shadow-xl relative">
          <h1 class="text-2xl font-sans font-bold mb-4">這個頁面無法找到</h1>
          ...
          <g-link to="/" class="text-sm text-teal-400 hover:text-teal-600 font-sans transition-color duration-300">&larr; 返回我們都網站 Back to our site</g-link>
        </section>
      </div>
    </main>
  </Layout>
